...
class FavoritePage:
    ...
    def open_page_item(self):
        ...
        browser.element('[class="option active"]').with_(timeout=600).should(have.text("соответствию запросу"))
        return self
    ...
    def open_favorites(self):
        ...
        browser.element('[class="is-desktop"]').with_(timeout=600).should(have.exact_text(
    ...
    def click_delete_to_favorites(self):
        ...
        browser.element('[class="text-20"]').with_(timeout=600).should(have.exact_text(
